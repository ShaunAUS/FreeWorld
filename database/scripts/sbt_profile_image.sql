...
CREATE TABLE `profile_image` (
  `profile_image_no` bigint NOT NULL AUTO_INCREMENT,
  `image_order` int DEFAULT NULL,
  `image_url` varchar(255) DEFAULT NULL,
  `profile_no` bigint DEFAULT NULL,
  PRIMARY KEY (`profile_image_no`),
  KEY `FKq27b2aoywammfo8o8h2595poy` (`profile_no`),
  CONSTRAINT `FKq27b2aoywammfo8o8h2595poy` FOREIGN KEY (`profile_no`) REFERENCES `profile` (`profile_no`)
